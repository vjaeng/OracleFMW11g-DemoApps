...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="XSD">
      <schema location="../../SensorActionData.xsd"/>
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.0.0(build 090105.0200.2377) AT [WED JAN 07 15:26:17 PST 2009]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl sensor tns nxsd xsd ns0 xsi xpath20 bpws oraext dvm hwf med mhdr ids xdk xref ora socket ldap">
  <xsl:template match="/">
    <ns0:_ProcessTimesCollection>
      <ns0:_ProcessTimes>
        ...
        <ns0:_CompositeVersion>
          <xsl:value-of select="/tns:actionData/tns:header/tns:processRevision"/>
        </ns0:_CompositeVersion>
        <ns0:_ReceiveOrder>
